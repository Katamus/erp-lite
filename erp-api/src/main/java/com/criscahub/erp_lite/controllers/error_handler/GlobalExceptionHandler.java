package com.criscahub.erp_lite.controllers.error_handler;

import com.criscahub.erp_lite.domain.exception.MyBussinessException;
import com.criscahub.erp_lite.dtos.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBusinessException(
            MyBussinessException ex, HttpServletRequest request
    ){
        log.warn("Rule MyBusinnesException detected");
    ...
    public ResponseEntity<Map<String,String>> handleMethodArgumentNotValidExceptionException(
