package com.criscahub.erp_lite.persistence.jpa.adapters;
...
import com.criscahub.erp_lite.persistence.jpa.entities.OrderEntity;
import com.criscahub.erp_lite.persistence.jpa.entities.OrderProductEntity;
import com.criscahub.erp_lite.persistence.jpa.mappers.OrderJpaMapper;
import com.criscahub.erp_lite.persistence.jpa.repositories.OrderRepository;
...
public class OrderRepositoryAdapter implements OrderRepositoryPort {
    ...
    public OrderRoot save(OrderRoot order) {
        ...
        try {
            ...
            OrderEntity saveOrderEntity = this.orderRepository.save(orderEntity);

            log.debug("Saved order success {}",saveOrderEntity);

            return this.orderJpaMapper.toDomain(orderEntity);
    ...
    public Optional<OrderRoot> findById(OrderId id) {
        log.debug("Findinf all orders by id {}",id);
        try {
    ...
    private void zipOrderItemsIds(OrderRoot root, OrderEntity entity){
        ...
        IntStream.range(0,itemsEntity.size()).forEach(i->
